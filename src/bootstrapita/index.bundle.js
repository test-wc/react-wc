...
@media (min-width: 768px) {
  ...
  .back-to-top bsi-icon {
    ...
    `}show(){this._element&&(this._element.classList.contains(vo)||this._element.classList.add(vo))}hide(){this._element&&this._element.classList.contains(vo)&&this._element.classList.remove(vo)}}customElements.define("bsi-back-to-top",zo);const So="blur",$o="active";class Eo{constructor(o,r){this._element=o,this._root=r,this._init()}static getInputFromLabel=o=>{if("undefined"!=typeof window&&"undefined"!=typeof document)return this._root.querySelector("#"+CSS.escape(o.getAttribute("for")))};_init(){const o=this._getLabel();o&&!o.classList.contains($o)&&(this._labelOut(),this._labelOver()),o&&null===o.getAttribute("it-bs-static")&&this._bindEvents()}_bindEvents(){["date","time"].includes(this._element.getAttribute("type"))||("file"===this._element.getAttribute("type")?this._element.addEventListener(So,(()=>{this._labelOut()})):(this._element.addEventListener("focus",(()=>{this._labelOut()})),this._element.addEventListener(So,(()=>{this._labelOver()})),this._element.addEventListener("change",(()=>{this._labelToggle()}))))}_getLabel(){return this._root.querySelector('label[for="'+this._element.getAttribute("id")+'"]')}_isEmpty(){return!this._element.value&&!this._element.getAttribute("placeholder")}_labelOut(){const o=this._getLabel();o&&o.classList.add($o)}_labelOver(){if(this._isEmpty()){const o=this._getLabel();o&&o.classList.remove($o)}}_labelToggle(){this._isEmpty()?this._labelOver():this._labelOut()}}var Co=e`/***************************** 1 ****************************************/
/***************************** 2 ****************************************/
/***************************** 1 ****************************************/
/***************************** 2 ****************************************/
/***************************** 1 ****************************************/
...
.bg-dark .btn-outline-secondary:not(:disabled):not(.disabled).active, .bg-dark .btn-outline-secondary:not(:disabled):not(.disabled):active, .show > .bg-dark .btn-outline-secondary.dropdown-toggle {
  box-shadow: none;
}`;class Uo extends no{static styles=_o;static properties={type:{type:String},variant:{type:String},_buttonClasses:{type:String},outline:{type:Boolean},disabled:{type:Boolean}};constructor(){super(),this.type="button",this.variant="",this.outline=!1,this.disabled=!1}firstUpdated(){this._buttonClasses=this._composeClass("btn",this.outline?"":""!==this.variant?`btn-${this.variant}`:"",this.outline?`${this.outline?"btn-outline-":""}${this.variant}`:"",this.disabled?"disabled":"")}render(){return D`
