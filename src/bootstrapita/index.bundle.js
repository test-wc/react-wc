...
.form-check input.semi-checked:not(:checked) + label::after {
  ...
  z-index: 0;
    ...
    `}}customElements.define("bsi-input",Ao);
/**
 * @license
...
.bg-dark .btn-outline-secondary:not(:disabled):not(.disabled).active, .bg-dark .btn-outline-secondary:not(:disabled):not(.disabled):active, .show > .bg-dark .btn-outline-secondary.dropdown-toggle {
  box-shadow: none;
}`;class To extends no{static styles=Uo;static get formAssociated(){return!0}static properties={type:{type:String},variant:{type:String},_buttonClasses:{type:String},outline:{type:Boolean},disabled:{type:Boolean},value:{type:String,reflect:!0}};constructor(){super(),this.type="button",this.variant="",this.outline=!1,this.disabled=!1,this.value=void 0,this.internals=this.attachInternals()}firstUpdated(){this._buttonClasses=this._composeClass("btn",this.outline?"":""!==this.variant?`btn-${this.variant}`:"",this.outline?`${this.outline?"btn-outline-":""}${this.variant}`:"",this.disabled?"disabled":"");const{internals:{form:o}}=this;this.renderRoot.querySelector("button").addEventListener("click",(()=>o.requestSubmit()))}updated(){this._buttonClasses=this._composeClass("btn",this.outline?"":""!==this.variant?`btn-${this.variant}`:"",this.outline?`${this.outline?"btn-outline-":""}${this.variant}`:"",this.disabled?"disabled":"")}render(){return D`
      <button
        type="${this.type}"
    ...
    `}}customElements.define("bsi-button",To);export{zo as BackToTop,To as Button,bo as Icon,Ao as Input};
